    									...
    									<tbody class="text-xs text-700 lh-1 align-middle">
    										<tr class="productItem mb-5 position-relative mb-lg-0 d-block d-lg-table-row px-3 px-sm-0 px-3 px-sm-0">
    											...
    											<td class="text-start mb-4 mb-sm-2 mb-lg-0 pt-4 pb-0 py-lg-3 d-inline-block d-lg-table-cell cell-item">
    												<img src="assets/images/Products/air_filter.png" alt="" class="me-2 d-inline d-sm-none d-xl-inline" width="51">
    										...
    										<tr class="productItem mb-5 position-relative mb-lg-0 d-block d-lg-table-row px-3 px-sm-0">
    											...
    											<td class="text-start mb-4 mb-sm-2 mb-lg-0 pt-4 pb-0 py-lg-3 d-inline-block d-lg-table-cell cell-item">
    												<img src="assets/images/Products/belt_engine.png" alt="" class="me-2 d-inline d-sm-none d-xl-inline" width="51">
    												Engine Belt
    											</td>
    											<td class="text-lg-center mb-4 mb-lg-0 py-0 py-lg-3 d-inline-block d-lg-table-cell cell-price">
    												<span class="text-white text-400 text-opacity-80 d-inline d-lg-none text-uppercase">UNIT PRICE </span>
    										...
    										<tr class="productItem mb-5 position-relative mb-lg-0 d-block d-lg-table-row px-3 px-sm-0">
    											...
    											<td class="text-start mb-4 mb-sm-2 mb-lg-0 pt-4 pb-0 py-lg-3 d-inline-block d-lg-table-cell cell-item">
    												<img src="assets/images/Products/badge.jpg" alt="" class="me-2 d-inline d-sm-none d-xl-inline" width="51">
    												ORV Club Badge
    											</td>
    											<td class="text-lg-center mb-4 mb-lg-0 py-0 py-lg-3 d-inline-block d-lg-table-cell cell-price">
    												<span class="text-white text-400 text-opacity-80 d-inline d-lg-none text-uppercase">UNIT PRICE </span>
    					...
    					<div class="tab-pane tab-user-details   fade" id="pills-user-details" role="tabpanel" aria-labelledby="pills-user-details-tab" tabindex="0">
    						<div class="row justify-content-center pb-5 pb-lg-0 mb-5 mb-lg-0">
    							...
    							<div class="col-12 col-lg-7 order-2 order-lg-1">									  								
    								<div class="card-bg-dark logbox card p-lg-4 rounded-3 d-flex flex-column h-100 text-center text-lg-start">
    									<h3 class="headline-3 lh-1 text-uppercase text-800 mb-5">
    										create new account
    									</h3>
                                        <p class="text-xs lh-sm mb-5 pb-2 d-inline-block d-lg-none">Don’t have an account? Create a free account and get tons of profits today.</p>
    									<ul class="mb-5 pb-3 text-xs lh-sm d-none d-lg-block">
    									...
    									<div class="row mt-auto justify-content-center">
    										<div class="col-10 col-sm-8 col-md-6 mb-4 mb-md-0 pb-2 pb-md-0">
    											<button class="btn btn-center btn-outline-white w-100 px-2 btn-next-tab">Continue as guest</button>
    										</div>
    										<div class="col-10 col-sm-8 col-md-6">
												<a href="register.php" class="btn btn-center btn-primary w-100 px-2">CREATE ACCOUNT</a>
    										</div>
    									</div>
    								</div>									
    							</div>
    							<div class="col-12 col-lg-5 order-1 order-lg-2 pb-4 pb-lg-0">
    								<form class="card-bg-dark logbox mt-5 mt-lg-0 py-5 p-lg-4 rounded-3 d-flex flex-column h-100 text-center text-lg-start">
    									...
    									<button class="btn btn-center btn-primary w-100 mt-5 mt-lg-auto">SIGN IN</button>
    								</form>
    							</div>
    						</div>
    					</div>
                                        ...
                                        <tbody class="text-xs text-700 lh-1 align-middle">
                                            <tr class="productItem mb-5 mb-lg-0 d-block d-lg-table-row px-3 px-sm-0">
                                                ...
                                                <td class="text-start mb-4 mb-sm-2 mb-lg-0 pt-4 pb-0 py-lg-2 d-inline-block d-lg-table-cell cell-item">
                                                    <img src="assets/images/Products/air_filter.png" alt="" class="me-2 d-inline d-sm-none d-xl-inline" width="36">
                                                    Air Engine Filter
                                                </td>
                                                <td class="text-lg-center mb-4 mb-lg-0 py-0 py-lg-3 d-inline-block d-lg-table-cell cell-price">
    												<span class="text-white text-400 text-opacity-80 d-inline d-lg-none text-uppercase">UNIT PRICE </span>
                                            ...
                                            <tr class="productItem mb-5 mb-lg-0 d-block d-lg-table-row px-3 px-sm-0">
                                                ...
                                                <td class="text-start mb-4 mb-sm-2 mb-lg-0 pt-4 pb-0 py-lg-2 d-inline-block d-lg-table-cell cell-item">
                                                    <img src="assets/images/Products/belt_engine.png" alt="" class="me-2 d-inline d-sm-none d-xl-inline" width="36">
                                                    Engine Belt
                                                </td>
                                                <td class="text-lg-center mb-4 mb-lg-0 py-0 py-lg-3 d-inline-block d-lg-table-cell cell-price">
    												<span class="text-white text-400 text-opacity-80 d-inline d-lg-none text-uppercase">UNIT PRICE </span>
                                            ...
                                            <tr class="productItem mb-5 mb-lg-0 d-block d-lg-table-row px-3 px-sm-0">
                                                ...
                                                <td class="text-start mb-4 mb-sm-2 mb-lg-0 pt-4 pb-0 py-lg-2 d-inline-block d-lg-table-cell cell-item">
                                                    <img src="assets/images/Products/badge.jpg" alt="" class="me-2 d-inline d-sm-none d-xl-inline" width="36">
                                                    ORV Club Badge
                                                </td>
                                                <td class="text-lg-center mb-4 mb-lg-0 py-0 py-lg-3 d-inline-block d-lg-table-cell cell-price">
    												<span class="text-white text-400 text-opacity-80 d-inline d-lg-none text-uppercase">UNIT PRICE </span>
                                            ...
                                            <tr class="productItem d-block d-lg-table-row">
