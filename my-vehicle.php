				...
				<div class="row justify-content-center">
					...
					<div class="col-12 col-lg-6 col-xxl-5 order-2 order-lg-1">
						...
						<div class="card bg-dark-opacity-40 rounded-3 p-3 vehicle-info">
							...
							<div class="row px-sm-3 pb-4 pt-1">
			...
			<div class="container-fluid px-0">
				<div class="row justify-content-center justify-content-lg-between">
					<div class="col-12 col-lg-9 col-xxl-10">
						<div class="row">	
							<div class="col-6 col-md-3 col-xl-2 mb-4 mb-md-0">
								<div class="square rounded-1 bg-black bg-black bg-opacity-20 position-relative border border-white border-opacity-05">
									<i class="icon-heart like-symbol position-absolute top-0 end-0 m-2 text-xxxs"></i>
					...
					<div class="col-10 col-md-5 col-lg-3 col-xxl-2 d-flex align-items-center ms-lg-auto mt-4 mt-lg-0 pt-2 pt-lg-0">
						<a href="cart-page.php" class="btn btn-primary w-100">
