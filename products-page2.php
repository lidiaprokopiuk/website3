								...
								<div class="swiper-slide slide-box col-12 col-sm-8 col-md-6 mt-5 mt-lg-0 d-flex align-items-center justify-content-center">
									<div class="pt-5 mt-xl-4 w-100">
										<div class="card searchCard card-product rounded-3 border-0 position-relative card-bg-dark mt-5 pt-5 mx-auto">
											...
											<div class="card-body mt-5 mt-lg-3 mt-xl-5 pt-5 pt-lg-0 pt-xl-5 pb-4 px-4">
												<h4 class="card-title headline-4 text-700 lh-1 mb-0 mb-xl-4 mt-4">Can-Am X2 Helment</h4>								
												<div class="d-flex justify-content-between align-items-center mb-3 mb-lg-0 mb-xl-2 pt-2">
								...
								<div class="swiper-slide slide-box col-12 col-sm-8 col-md-6 mt-5 mt-lg-0 d-flex align-items-center justify-content-center">
									<div class="pt-5 mt-xl-4 w-100">
										<div class="card searchCard card-product rounded-3 border-0 position-relative card-bg-dark mt-5 pt-5 mx-auto">
											...
											<div class="card-body mt-5 mt-lg-3 mt-xl-5 pt-5 pt-lg-0 pt-xl-5 pb-4 px-4">
												<h4 class="card-title headline-4 text-700 lh-1 mb-0 mb-xl-4 mt-4">23’ Cross Wheels 1221</h4>								
												<div class="d-flex justify-content-between align-items-center mb-3 mb-lg-0 mb-xl-2 pt-2">
													<p class="text-xxs lh-1 text-700 text-uppercase text-primary mb-0">fix price</p>
													<p class="mb-0" role="button">
														<i class="icon-heart like-symbol text-xxxs d-inline-block align-middle"></i>
								...
								<div class="swiper-slide slide-box col-12 col-sm-8 col-md-6 mt-5 mt-lg-0 d-flex align-items-center justify-content-center">
									<div class="pt-5 mt-xl-4 w-100">
										<div class="card searchCard card-product rounded-3 border-0 position-relative card-bg-dark mt-5 pt-5 mx-auto">
											...
											<div class="card-body mt-5 mt-lg-3 mt-xl-5 pt-5 pt-lg-0 pt-xl-5 pb-4 px-4">
												<h4 class="card-title headline-4 text-700 lh-1 mb-0 mb-xl-4 mt-4">Air Filter</h4>								
												<div class="d-flex justify-content-between align-items-center mb-3 mb-lg-0 mb-xl-2 pt-2">
													<p class="text-xxs lh-1 text-700 text-uppercase text-primary mb-0">fix price</p>
													<p class="mb-0" role="button">
														<i class="icon-heart like-symbol text-xxxs d-inline-block align-middle"></i>
								...
								<div class="swiper-slide slide-box col-12 col-sm-8 col-md-6 mt-5 mt-lg-0 d-flex align-items-center justify-content-center">
									<div class="pt-5 mt-xl-4 w-100">
										<div class="card searchCard card-product rounded-3 border-0 position-relative card-bg-dark mt-5 pt-5 mx-auto">
											...
											<div class="card-body mt-5 mt-lg-3 mt-xl-5 pt-5 pt-lg-0 pt-xl-5 pb-4 px-4">
												<h4 class="card-title headline-4 text-700 lh-1 mb-0 mb-xl-4 mt-4">Belt Engine</h4>								
												<div class="d-flex justify-content-between align-items-center mb-3 mb-lg-0 mb-xl-2 pt-2">
													<p class="text-xxs lh-1 text-700 text-uppercase text-primary mb-0">fix price</p>
													<p class="mb-0" role="button">
														<i class="icon-heart like-symbol text-xxxs d-inline-block align-middle"></i>
								...
								<div class="swiper-slide slide-box col-12 col-sm-8 col-md-6 mt-5 mt-lg-0 d-flex align-items-center justify-content-center">
									<div class="pt-5 mt-xl-4 w-100">
										<div class="card searchCard card-product rounded-3 border-0 position-relative card-bg-dark mt-5 pt-5 mx-auto">
											...
											<div class="card-body mt-5 mt-lg-3 mt-xl-5 pt-5 pt-lg-0 pt-xl-5 pb-4 px-4">
												<h4 class="card-title headline-4 text-700 lh-1 mb-0 mb-xl-4 mt-4">Can-Am X1 Helment</h4>								
												<div class="d-flex justify-content-between align-items-center mb-3 mb-lg-0 mb-xl-2 pt-2">
													<p class="text-xxs lh-1 text-700 text-uppercase text-primary mb-0">fix price</p>
													<p class="mb-0" role="button">
														<i class="icon-heart like-symbol text-xxxs d-inline-block align-middle"></i>
		...
		<section class="section-filtr fixed-bottom bg-gradient-dark content-item">
			...
			<div class="container-fluid">
				<div class="row justify-content-center px-5 px-lg-0">
					...
					<div class="col-12 col-lg-3 border border-white border-opacity-05 p-lg-4 p-xl-5 see-more-options">
					...
					<div class="col-12 col-lg-9 p-lg-4 p-xl-5 border border-white border-opacity-05 border-start-0 mb-5 mb-lg-0">
