    ...
    <main class="pb-lg-5 pt-lg-4 d-lg-flex align-items-lg-center login-page mb-8 mb-lg-0">
        <div class="container-lg">
            <div class="row justify-content-center">
                <div class="col-12 col-lg-8 col-xxl-6 card-bg-dark rounded-3 py-5 login-box d-flex d-lg-block flex-column justify-content-center">
                    ...
                    <form class="register-verify-form row justify-content-center pb-lg-2"> 
                        <div class="col-12 col-md-10 col-lg-9 col-xl-8 col-xxl-9">                            
                            <input type="text" class="form-control form-control-gray form-control-sm mb-6 text-center letter-spacing-25" name="Verify" pattern="[0-9]{6}" placeholder="_____" required>
                                
                            
                        </div>
                        
                        <div class="col-12 col-md-10 col-lg-6 col-xl-5 col-xxl-6">
                            <button type="submit" class="btn btn-primary btn-center w-100 mb-6">VERIFY</button>                            
                        </div>
