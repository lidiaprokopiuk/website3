    ...
    <div class="p-4">
        <div class="offcanvas-header p-0">
            <h5 class="offcanvas-title" id="offcanvasLabel">
                Cart 
                <span class="productsNumber" id="howManyProducts">z</span>
            </h5>
            <button type="button" class="btn-close btn-close-white opacity-100" data-bs-dismiss="offcanvas" aria-label="Close">						
            </button>					
        </div>
        <hr class="mt-2 mb-4">
        <div class="offcanvas-body p-0">
            <div class="background-card rounded-3 p-3 p-sm-4 d-flex align-items-center mb-4 productItem">
                <img src="assets/images/Products/air_filter.png" class="object-fit-contain me-3" height="116" width="111" alt="">
                <div class="d-flex flex-column w-100">
                    <h4 class="headline-4 text-700 mb-2">Air Engine Filter</h4>
                    ...
                    <div class="d-flex align-items-center mt-4 mt-sm-0">
                        <p class="text-xs text-uppercase me-3 mb-0">FINAL PRICE</p>
                        <p class="text-md text-600 mb-0">$<span class="totalCost">0</span></p>
                    </div>
                </div>
            </div>
            <div class="background-card rounded-3 p-3 p-sm-4 d-flex align-items-center mb-4 productItem">
                <img src="assets/images/Products/belt_engine.png" class="object-fit-contain me-3" height="116" width="111" alt="">
                <div class="d-flex flex-column w-100">
                    <h4 class="headline-4 text-700 mb-2">Air Engine Filter</h4>
                    <div class="d-sm-flex justify-content-between align-items-center mb-auto">
            ...
            <a href="cart-page.php" class="btn btn-primary btn-center btn-xl w-100">
                <span class="btn-text">see all items</span> 
            </a>
        </div>
    </div>
</div>